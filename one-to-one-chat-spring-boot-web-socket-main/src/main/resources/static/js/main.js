...
//     // Add "AI replied:" text above AI messages
//     if (senderId === "AI") {
//         const aiLabel = document.createElement('div');
//         aiLabel.textContent = "AI replied:";
//         aiLabel.style.fontSize = "14px"; // Keep it subtle
//         aiLabel.style.fontWeight = "bold";
//         aiLabel.style.marginBottom = "2px";
//         messageContainer.appendChild(aiLabel);
//     }
...
function displayMessage(senderId, content) {
    ...
    if (senderId === userId) {
        messageContainer.classList.add('sender'); // User messages on right
    } else if (senderId === "AI") {
        messageContainer.classList.add('ai-message'); // AI messages in center
    } else {
        messageContainer.classList.add('receiver'); // Other user messages on left
    }
